...
Motherboard Diagnostics - это приложение на C# с использованием WPF, предназначенное для тестирования различных компонентов материнской платы ASUS PRIME x399-A. Программа имитирует тесты напряжения, сопротивления, сокета ЦПУ, слотов ОЗУ, слотов PCIe, BIOS, батарейки BIOS, линий USB и кварцевых резонаторов.
